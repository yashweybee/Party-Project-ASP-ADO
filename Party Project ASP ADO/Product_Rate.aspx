    ...
    <table class="auto-style15" style="vertical-align: middle; text-align: center">
        ...
        <tr>
            ...
            <td class="auto-style18" style="text-align: left; vertical-align: middle">
                <asp:DropDownList ID="ddProductName" runat="server" DataSourceID="SqlDataSource1" DataTextField="Name" DataValueField="Name">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td class="auto-style18" style="text-align: left; vertical-align: middle">
                <asp:TextBox ID="txtBoxProductRate" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style16" style="text-align: left; vertical-align: middle">&nbsp;</td>
        ...
        <tr>
            ...
            <td class="auto-style17" style="text-align: left; vertical-align: middle"></td>
            <td class="auto-style18" style="text-align: left; vertical-align: middle">
                <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Save" Width="60px" style="height: 26px" />
&nbsp;
